...
$(BIN_DIR)/chunk_upload: src_cgi/chunk_upload_cgi.c $(COMMON) common/chunk_upload_repository.c common/upload_id.c common/md5.c common/user_validation.c common/token_service.c | $(BIN_DIR)
	$(CC) $(CFLAGS) $^ -o $@ $(FCGI_LIBS) $(MYSQL_LIBS) $(REDIS_LIBS)
